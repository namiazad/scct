package com.github.scct.report

import org.specs2.mutable._
import java.io.File
import com.github.scct.{ IO, ClassTypes, Name, CoveredBlock }
import xml.XML
...
class CoberturaReporterSpec extends Specification {
  ...
  val name = Name(sourceFile.getName, ClassTypes.Class, "com.github.scct.report", "CoberturaReportSpec", "scct")
  ...
  "report output" in new CleanEnv {
    ...
    XML.loadFile(outputFile) must beEqualToIgnoringSpace(
      <coverage line-rate="0.75">
        <packages>
          <package line-rate="0.75" name="com.github.scct.report">
            <classes>
